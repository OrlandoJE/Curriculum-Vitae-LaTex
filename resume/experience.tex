...
\begin{cventries}
  ...
  {
    \begin{cvitems}
      \item {\textit{Galenic formulation} of the medical device for \textbf{oral, nasal and veterinarian applications}.}
      \item {Research on the use of proprietary \textit{medical device} on \textbf{oncological wounds}.}
      \item {Cultivation \textit{chamber design} and optimization for \textbf{microalgae growth}.}
    \end{cvitems}
  }
