...
\begin{cvletter}
  \cvletter{
    ...
    \ifbool{showprogramming}{
      Experienced in Python, Java and Kotlin for development. Adept in PowerBI and MATLAB for data analysis and visualization. Proficient in web development with tools such as React, Astro, Node.js, and TypeScript and integrating AI solutions for practical applications.
    }{}
